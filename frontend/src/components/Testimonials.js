      ...
      <div className="container mx-auto px-4 flex flex-col lg:items-center justify-between lg:flex-row">
        <div className="mb-14 xl:mb-0">
          <h1 className="text-2xl leading-tight md:text-4xl xl:text-5xl font-semibold leading-10   text-gray-800 xl:w-2/3 pr-16 lg:pr-0">
            Our teachers & customers love what we do
          </h1>
          <p className="mt-4 text-base leading-normal text-gray-600 md:w-2/3 lg:w-3/4 pr-16 lg:pr-0">
            Over 500 teachers and customer use our product to understand their
            business and marketing better.
          </p>
        ...
        >
            ...
            <div className="pl-4 pt-4 flex items-start justify-between">
              <div className="mr-6">
                <p className="xl:text-xl xl:leading-loose text-gray-600">
                  This website has a bunch of amazing products which is cheaper
              ...
              <img
                src="https://www.heritageit.edu/FacultyImage/BAPPA_SARDER.JPG"
                alt="Display Avatar of Bappa"
                role="img"
              />
            </div>
          </div>
          <div role="listitem" className="bg-white shadow rounded p-4 xl:p-8">
            ...
            <div className="pl-4 pt-4 flex items-start justify-between">
              <div className="mr-6">
                <p className="xl:text-xl xl:leading-loose text-gray-600">
                  This website is very to operate and the navigation between the
                  pages is very fast.
                </p>
                <p className="mt-4 text-base font-semibold leading-none text-gray-800">
                  HD Sir
              ...
              <img
                ...
                src="https://www.heritageit.edu/FacultyImage/Hemanta_De.JPG"
                alt="Display avatar of HD"
                role="img"
              />
            </div>
          </div>
          <div role="listitem" className="bg-white shadow rounded p-4 xl:p-8">
            ...
            <div className="pl-4 pt-4 flex items-start justify-between">
              <div className="mr-6">
                <p className="xl:text-xl xl:leading-loose text-gray-600">
                  Best website to buy products without any headache also payment
                  method is simple and seemless.
                </p>
                <p className="mt-4 text-base font-semibold leading-none text-gray-800">
                  Manas Sir
                </p>
              ...
              <img
                ...
                src="https://www.heritageit.edu/TAImage/MANASH_BHATTACHARYA.JPG"
                alt="Display Avatar of Manas"
                role="img"
              />
            </div>
          </div>
